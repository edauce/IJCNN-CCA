...
class CCA_Trainer:
    ...
    def __init__(self, env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        logger_kwargs=dict(), save_freq=1, bandwidth=0.1):
    ...
    """  
        ...
        self.logger.log('\nNumber of parameters: \t pi: %d, %d, \t q: %d, %d, %d, %d\n'%var_counts)        
    ...
    def compute_loss_q(self, data):
        ...
        with torch.no_grad():
            ...
            lik_1 = - 0.5 * diff_1**2 
            lik_2 = - 0.5 * diff_2**2 
            backup_1 =  (1 - self.gamma)/self.beta * (lik_1 + (1 - done_KL)/self.prec * R_S) + self.gamma * (1 - done) *  q_targ
            backup_2 =  (1 - self.gamma)/self.beta * (lik_2 + (1 - done_KL)/self.prec * R_S) + self.gamma * (1 - done) *  q_targ
        ...
        loss_q = loss_q1 + loss_q2 + loss_q1_ref + loss_q2_ref
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, default='cca') 
